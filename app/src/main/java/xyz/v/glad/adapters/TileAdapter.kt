...
class TileAdapter(val tileList:ArrayList<RpDao>): RecyclerView.Adapter<TileAdapter.Mvh>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Mvh {
        return Mvh(LayoutInflater.from(parent.context).inflate(R.layout.rp_card, parent, false))
    }
